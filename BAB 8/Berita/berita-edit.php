    ...
    <div class="home-content">
       ...
       <div class="form-login">
        <form action="berita-proses.php" method="post" enctype="multipart/form-data">
           ...
           <input class="input" type="text" name="judul" id="judul" value="<?= $data['judul'] ?>" required />
           <label for="kejadian">Kejadian</label>
           <input class="input" type="text" name="kejadian" id="kejadian"  value="<?= $data['kejadian']?>" required />
